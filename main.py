...
async def assign_gatherer_role(member: discord.Member, guild: discord.Guild) -> tuple[str | None, str | None]:
    ...
    # All Planter roles use Roman numerals
    planter_roles = ["PLANTER I", "PLANTER II", "PLANTER III", "PLANTER IV", "PLANTER V", 
                     "PLANTER VI", "PLANTER VII", "PLANTER VIII", "PLANTER IX", "PLANTER X"]
    ...
    if total_forage_count < 50:
        target_role_name = "PLANTER I"  # Default to Planter I, not New Recruit
    elif total_forage_count < 150:
        target_role_name = "PLANTER II"
    elif total_forage_count < 300:
        target_role_name = "PLANTER III"
    elif total_forage_count < 500:
...
async def userstats(interaction: discord.Interaction):
    ...
    elif forage_count < 300:
        items_needed = 300 - forage_count
        next_rank = "PLANTER IV"
    elif forage_count < 500:
        items_needed = 500 - forage_count
        next_rank = "PLANTER V"
    elif forage_count < 1000:
        items_needed = 1000 - forage_count
        next_rank = "PLANTER VI"
    elif forage_count < 2000:
        items_needed = 2000 - forage_count
        next_rank = "PLANTER VII"
    elif forage_count < 4000:
        items_needed = 4000 - forage_count
        next_rank = "PLANTER VIII"
    elif forage_count < 8000:
        items_needed = 8000 - forage_count
        next_rank = "PLANTER IX"
    elif forage_count < 65000:
        items_needed = 65000 - forage_count
        next_rank = "PLANTER X"
    else:
        # Max rank achieved
        items_needed = 0
